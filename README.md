About
================
Keyroom is a small cozy web chatroom created as a small, fun project where anybody can create their own instance and host it for free using Google Firebase. We welcome you to visit us at any of the following or create your own instance using the instructions found in setup.md: <br>
